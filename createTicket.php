...
<body>
    ...
    <div class="container text-center mx-0">
        ...
        <div class="d-flex flex-row justify-content-center align-items-start gap-2 mt-3">
            ...
            <div class="col col-6" id="divTab3">
                <table id="idTable3" class="table-3" data-id="3">
                </table>                                    
            </div>                        

            <div class="col col-6" id="divTab4">
        ...
        <div>        
            <button class="btn btn-primary btn-lg"  onclick="createTicket()">createTicket</button>
        </div>
